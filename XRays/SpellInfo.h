...
enum SpellFlags {
  ...
  // Custom flags set by us. These flags cant be unpacked from the game files
  // (exception Targeted flag).
  ProjectedDestination = 1 << 22,

  AffectAllyMob = AffectAllyLaneMinion | AffectAllyNonLaneMinion,
  AffectEnemyMob =
      AffectEnemyLaneMinion | AffectEnemyNonLaneMinion | AffectJungleMonster,

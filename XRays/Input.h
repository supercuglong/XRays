...
static const char *HKeyNames[] = {
    ...
    "LShift",    "\\",      "Z",    "X",       "C",        "V",      "B",
    "N",         "M",       ",",    ".",       "/",        "RShift", "PrtScrn",
    "Alt",       "Space",   "Caps", "F1",      "F2",       "F3",     "F4",
    "F5",        "F6",      "F7",   "F8",      "F9",       "F10",    "Num",
    "Scrl",      "Home",    "Num8", "PgUp",    "NumMinus", "Num4",   "Num5",
    "Num6",      "NumPlus", "End",  "NumDown", "PgDown",   "Insert", "Del"};

/// Keyboard/Mouse input related utilities. For keyboards the hardware key codes
/// are used instead of the virtual ones.
namespace Input {
...
/// Checks if a key was pressed recently. Only one caller can use this function
/// for a given key.
...
/// Moves the cursor at the specified location, clicks and then moves the cursor

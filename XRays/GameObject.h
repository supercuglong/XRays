...
public:
  ...
  std::chrono::high_resolution_clock::time_point timeSinceLastPreviousPosition;
...
public:
  ...
  bool IsRanged();
  luabridge::LuaRef ItemsToList();
  luabridge::LuaRef BuffsToList();

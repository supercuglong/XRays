...
int Offsets::ObjBaseAtk = 0x12A4; // risky
int Offsets::ObjBonusAtk = 0x121C;
int Offsets::ObjMoveSpeed = 0x18f0;
...
int Offsets::IsMoving = 0x40C;
int Offsets::NavBegin = 0x1BC;
int Offsets::NavEnd = 0x1C0;

int Offsets::ViewProjMatrices = 0x30FF708;
int Offsets::Renderer = 0x310257C;
...
int Offsets::ObjectManager = 0x183e1a0;
int Offsets::LocalPlayer = 0x30DA914;
...
int Offsets::MissileSpellInfo = 0x258; // 0x258
...
int Offsets::MinimapObject = 0x30DA91C;
...
int Offsets::AiManagerIsMoving = 0x40C;

...
struct Vector2 {
  ...
  Vector2 vscale(const Vector2 &s) { return Vector2(x * s.x, y * s.y); }

  Vector2 scale(float s) { return Vector2(x * s, y * s); }
  ...
  Vector2 add(const Vector2 &o) { return Vector2(x + o.x, y + o.y); }

  Vector2 sub(const Vector2 &o) { return Vector2(x - o.x, y - o.y); }
...
struct Vector3 {
  ...
  Vector3 rotate_x(float angle) {
    return Vector3(x, y * cos(angle) - z * sin(angle),
                   y * sin(angle) + z * cos(angle));
  }

  Vector3 rotate_y(float angle) {
    return Vector3(x * cos(angle) + z * sin(angle), y,
  ...
  Vector3 scale(float s) { return Vector3(x * s, y * s, z * s); }
  ...
  Vector3 add(const Vector3 &o) { return Vector3(x + o.x, y + o.y, z + o.z); }

  Vector3 sub(const Vector3 &o) { return Vector3(x - o.x, y - o.y, z - o.z); }
...
struct Vector4 {
  ...
  Vector4 scale(float s) { return Vector4(x * s, y * s, z * s, w * s); }
  ...
  Vector4 clone() { return Vector4(x, y, z, w); }
};

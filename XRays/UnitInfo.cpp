...
std::map<std::string, UnitTag> UnitInfo::TagMapping = {
    ...
    {std::string("Unit_Minion_SummonName_game_character_displayname_ZyraSeed"),
    ...
    {std::string("Unit_Special_EpicMonsterIgnores"),
    ...
    {std::string("Unit_Special_UntargetableBySpells"),
